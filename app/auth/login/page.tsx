      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="glassmorphism p-8 rounded-3xl shadow-xl">
          ...
          <button
            ...
            className="w-full flex justify-center items-center px-6 py-3 border border-gray-300 rounded-xl shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-smooth"
          >
